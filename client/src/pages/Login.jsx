                ...
                {!showOTP ? (
                    <>
                        <div>
                            ...
                            <input
                                type="email"
                                required
                                className="w-full px-4 py-3 rounded-lg border border-gray-300 text-gray-900 bg-white focus:ring-2 focus:ring-gray-700 focus:border-gray-900 transition shadow-sm"
                                value={email}
                        ...
                        <div>
                            ...
                            <input
                                type="password"
                                required
                                className="w-full px-4 py-3 rounded-lg border border-gray-300 text-gray-900 bg-white focus:ring-2 focus:ring-gray-700 focus:border-gray-700 transition shadow-sm"
                                value={password}
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-4 py-3 rounded-lg border border-gray-300 text-gray-900 bg-white  focus:ring-2 focus:ring-gray-700 transition shadow-sm font-bold tracking-widest text-center text-lg"
                            value={otp}
